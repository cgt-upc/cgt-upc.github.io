...
La [**CGT**](https://cgt-upc.github.io/) dona suport a la candidatura: "**Universitat Roja i Negra**" que es presenta al Claustre dins el **sector PA-B2**

"**Universitat Roja i Negra**" el conformen persones treballadores de la **CGT**

**Per què es presenten?**

El model universitari se sustenta sobre l’explotació i la precarietat. Es tracta del desmantellament d’un servei públic sota el model neoliberal. A això hem de sumar un caràcter jeràrquic de la institució. Des de la CGT ens oposem frontalment. Volem una universitat popular, democràtica, feminista, amb treballs dignes.
...
Hem organitzat múltiples accions de protesta:
...
* Dignificar les condicions laborals de tot el PA contractat: investigadores predoctorals, professores associades i substitutes, investigadores postdoctorals, lectores i agregades.
* Augmentar el salari del professorat associat.
* Aconseguir dignitat laboral i salarial per a la nova figura del professorat substitut.
* Garantir la continuïtat de la carrera acadèmica per a tothom: professorat associat, investigadorxs predoctorals i postdoctorals i professorat lector.
* Equiparar les condicions laborals i salarials del professorat agregat amb les del titular.
* Erradicar qualsevol pràctica abusiva o d’exclusió per raó de gènere, diferència sexual, classe social, racialització o diversitat funcional.
* Treballar per una Universitat en català i democràtica.
* Treballar per una universitat pública activa i posicionada contra els feixismes i els genocidis.
* Vetllar per una universitat compromesa amb el respecte pel medi ambient i una sostenibilitat allunyada del màrqueting verd i la salut ambiental en els llocs de treball.
